    ...
    <>
      ...
      <div className="   py-0 px-4 md:px-0  md:py-20 lg:px-0 lg:py-20">
        <div className=" flex  flex-col items-center justify-center lg:ml-44 sm:flex-col md:flex-row md:justify-start  md:items-center lg:flex-row lg:items-center lg:justify-start">
          ...
          <div className=" sm:w-full md:w-[40%] mt-4 lg:w-[40%] flex flex-col justify-center items-center ml-8  ">
            <img
      ...
      <div className="bg-[#061133] p-2">
        ...
        <div
          className="flex flex-row flex-wrap justify-center items-center text-center md:text-left lg:text-left md:flex-row  md:justify-between md:items-start lg:flex-row lg:items-start lg:justify-between lg:w-[80%]  lg:ml-44 py-5 lg:pb-28"
